...
cl3 = Column([len(cat_macs0717),nodata[0][2],both[0][2],phot_only[0][2],star[0][2],SF[0][2],Q[0][2],out[0][2]])
cl4 = Column([len(cat_abell370),nodata[0][3],both[0][3],phot_only[0][3],star[0][3],SF[0][3],Q[0][3],out[0][3]])
cl5 = Column([len(cat_abell1063),nodata[0][4],both[0][4],phot_only[0][4],star[0][4],SF[0][4],Q[0][4],out[0][4]])
cl6 = Column([len(cat_abell2744),nodata[0][5],both[0][5],phot_only[0][5],star[0][5],SF[0][5],Q[0][5],out[0][5]])
macros = Table([macro_names,total,cl1,cl2,cl3,cl4,cl5,cl6],names=('Property','Full catalogue','1.macs0416','2.macs1149','3.macs0717','4.abell370','5.abell1063','6.abel2744'))
#
...
spec_stats = Table([spec_names,total_mems,cl1_mems,cl2_mems,cl3_mems,cl4_mems,cl5_mems,cl6_mems],names=('Property','Full catalogue','1.macs0416','2.macs1149','3.macs0717','4.abell370','5.abell1063','6.abel2744'))
#
#
#
#
...
phot_stats = Table([phot_names,total_memp,cl1_memp,cl2_memp,cl3_memp,cl4_memp,cl5_memp,cl6_memp],names=('Property','Full catalogue','1.macs0416','2.macs1149','3.macs0717','4.abell370','5.abell1063','6.abel2744'))
#
