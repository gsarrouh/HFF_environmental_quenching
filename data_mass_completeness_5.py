...
diag_flag_2 = 0           # display result: limiting mag, limiting mass, magnitude of object chosen as limiting mass
diag_flag_3 = 0           # prints the indices of objects w/ "NaN" mass estimates;  
diag_flag_4 = 0           # AVAILABLE
...
if plot_flag_1 == 1:
    for cluster in range(len(limiting_mag)):
        ...
        plt.text(22.1,11.5,'$M/L_{max}$: %s'%limiting_mass[cluster],fontsize=10)
