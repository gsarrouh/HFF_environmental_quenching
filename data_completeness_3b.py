...
##  v3b: includes spec sample w/ the phot plot, and disregards spec_only for a 
##      better represetnation of selected members w/ photometry
#
...
#            else: out2 +=1                  # # of spec objects w/o F160 flux
        ...
        a +=1   #count for spec&phot samples
#        if master_cat[counter]['member'] ==0:
        if master_cat[counter]['f_F160W'] >0:
