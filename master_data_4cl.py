    ...
    while counter < size:
        if master_cat[counter]['sub'] == 1:       # ['sub'] == 1: spec
            if master_cat[counter]['type'] == 0 or master_cat[counter]['type'] ==3:    #['type'] == 0: stars,    ['type'] == 3: spec_only
                ...
                if abs(master_cat[counter]['z_clusterspec']) > 0.01 and abs(master_cat[counter]['z_clusterphot']) > 0.04:  # secure field
                    ...
                    if master_cat[counter]['cluster'] == 1:
                        ...
                        sfield[0][5] +=1  
                elif abs(master_cat[counter]['z_clusterspec']) > 0.01 and abs(master_cat[counter]['z_clusterphot']) < 0.04:  #  false positive
                ...
                elif abs(master_cat[counter]['z_clusterspec']) < 0.01 and abs(master_cat[counter]['z_clusterphot']) > 0.04:  #  false negative
                ...
                if abs(master_cat[counter]['z_clusterspec']) > 0.01 and abs(master_cat[counter]['z_clusterphot']) > 0.06:  # secure field
                    master_cat[counter]['member'] = 1       #field
                    if master_cat[counter]['cluster'] == 1:
                        qfield[0][0] +=1
                    elif master_cat[counter]['cluster'] == 2:
                        ...
                        qfield[0][5] +=1  
                elif abs(master_cat[counter]['z_clusterspec']) > 0.01 and abs(master_cat[counter]['z_clusterphot']) < 0.06:  #  false positive
                    master_cat[counter]['member'] = 2       #false positive
                    if master_cat[counter]['cluster'] == 1:
                        qpos[0][0] +=1
                ...
                elif abs(master_cat[counter]['z_clusterspec']) < 0.01 and abs(master_cat[counter]['z_clusterphot']) > 0.06:  #  false negative
                    master_cat[counter]['member'] = 3       #false negative
                    if master_cat[counter]['cluster'] == 1:
                        qneg[0][0] +=1
...
#### i just changed the false pos/neg cutoff limits